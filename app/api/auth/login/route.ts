...
export async function POST(request: NextRequest) {
  try {
    ...
    if (result.success && result.user) {
      // Device management (optional - agar jadval mavjud bo'lsa)
      try {
        ...
        console.error('Device management error (ignoring):', deviceError);
        // Device management xatosi bo'lsa, login jarayonini davom ettirish
      }
