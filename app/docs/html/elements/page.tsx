...
export default function HTMLElementsPage() {
  return (
    <div className="max-w-none">
      ...
      {/* Video Section */}
      <div className="mb-12 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-8 hover:border-blue-500/40 transition-all">
