...
export default function CSSColorsPage() {
  return (
    <div className="max-w-none">
      ...
      {/* Video Section */}
      <div className="mb-12 bg-gradient-to-br from-red-500/10 to-pink-500/10 border border-red-500/20 rounded-2xl p-8 hover:border-red-500/40 transition-all">
        ...
        <div className="bg-gray-900/50 rounded-xl p-8 text-center hover:bg-gray-900/70 transition-all">
          <p className="text-gray-400 mb-4">CSS Ranglar - Video dars</p>
          <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center border border-gray-700 hover:border-red-500/50 transition-all">
